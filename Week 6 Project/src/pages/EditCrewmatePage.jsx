...
export default function EditCrewmatePage() {
  ...
  const handleDelete = async () => {
    const confirmed = window.confirm('Delete this crewmate from your roster?')
    if (!confirmed) return
  ...
  return (
    <div className="page edit-page">
      <header className="page-header">
        <div>
          <p className="eyebrow">Update crewmate</p>
          <h1>Fine-tune {crewmate.name}</h1>
          <p>Adjust their role, specialty, or backstory. Changes save instantly.</p>
        </div>
